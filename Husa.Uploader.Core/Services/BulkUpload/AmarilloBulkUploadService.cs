namespace Husa.Uploader.Core.Services.BulkUpload
{
    ...
    public class AmarilloBulkUploadService : IAmarilloBulkUploadService
    {
        private readonly IUploaderClient uploaderClient;
        private readonly IAmarilloUploadService uploadService;
        private readonly ILogger<AmarilloBulkUploadService> logger;

        public AmarilloBulkUploadService(
            IUploaderClient uploaderClient,
            IAmarilloUploadService uploadService,
            ILogger<AmarilloBulkUploadService> logger)
        {
