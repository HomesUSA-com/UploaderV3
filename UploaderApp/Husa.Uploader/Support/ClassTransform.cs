        ...
        public IEnumerable<ResidentialListingRequest> CosmoObjectToResidentialListingRequest(IEnumerable<ListingRequestSale> listingsRequestSale)
        {
            ...
            if(listingsRequestSale != null)
            {
                foreach (var listingRequest in listingsRequestSale)
                {
                    ...
                    foreach (var openHouse in listingRequest.SaleProperty.OpenHouses)
                    {
                        switch (openHouse.Type) 
                        {
                            case "Saturday":
                                //residentialListingRequest.OHRefreshmentsSat = openHouse.Refreshments;
                                residentialListingRequest.OHStartTimeSat = openHouse.StartTime != null ? openHouse.StartTime.ToString() : "";
                                residentialListingRequest.OHEndTimeSat = openHouse.EndTime != null ? openHouse.EndTime.ToString() : "";
                            ...
                            case "Sunday":
                                ...
                                residentialListingRequest.OHStartTimeSun = openHouse.StartTime != null ? openHouse.StartTime.ToString() : "";
                                residentialListingRequest.OHEndTimeSun = openHouse.EndTime != null ? openHouse.EndTime.ToString() : "";
                            ...
                            case "Monday":
                                ...
                                residentialListingRequest.OHStartTimeMon = openHouse.StartTime != null ? openHouse.StartTime.ToString() : "";
                                residentialListingRequest.OHEndTimeMon = openHouse.EndTime != null ? openHouse.EndTime.ToString() : "";
                            ...
                            case "Tuesday":
                                ...
                                residentialListingRequest.OHStartTimeTue = openHouse.StartTime != null ? openHouse.StartTime.ToString() : "";
                                residentialListingRequest.OHEndTimeTue = openHouse.EndTime != null ? openHouse.EndTime.ToString() : "";
                            ...
                            case "Wednesday":
                                ...
                                residentialListingRequest.OHStartTimeWed = openHouse.StartTime != null ? openHouse.StartTime.ToString() : "";
                                residentialListingRequest.OHEndTimeWed = openHouse.EndTime != null ? openHouse.EndTime.ToString() : "";
                            ...
                            case "Thursday":
                                ...
                                residentialListingRequest.OHStartTimeThu = openHouse.StartTime != null ? openHouse.StartTime.ToString() : "";
                                residentialListingRequest.OHEndTimeThu = openHouse.EndTime != null ? openHouse.EndTime.ToString() : "";
                            ...
                            case "Friday":
                                ...
                                residentialListingRequest.OHStartTimeFri = openHouse.StartTime != null ? openHouse.StartTime.ToString() : "";
                                residentialListingRequest.OHEndTimeFri = openHouse.EndTime != null ? openHouse.EndTime.ToString() : "";
