namespace Husa.Uploader.Data.Tests
{
    ...
    public class CtxListingRequestTests
    {
        public object Market { get; private set; }

        [Fact]
        public void CreateCtxListingRequest_ThrowsOnNullListingSaleQueryResponse()
        {
            // Arrange
            // Act
            var sut = () => new CtxListingRequest(listingResponse: null);
        ...
        [Fact]
        public void CreateCtxListingRequest_ThrowsOnNullListingSaleRequestDetailResponse()
        {
            // Arrange
            // Act
            var sut = () => new CtxListingRequest(listingDetailResponse: null);
        ...
        public void CreateFromApiResponse_ReturnsResidentialListingRequest()
        {
            ...
            var sut = new CtxListingRequest(listingResponse);
            ...
            Assert.IsType<CtxListingRequest>(result);
