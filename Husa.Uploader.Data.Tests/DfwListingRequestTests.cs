namespace Husa.Uploader.Data.Tests
{
    ...
    public class DfwListingRequestTests
    {
        public object Market { get; private set; }

        [Fact]
        public void CreateDfwListingRequest_ThrowsOnNullListingSaleQueryResponse()
        {
            // Arrange
            // Act
            var sut = () => new DfwListingRequest(listingResponse: null);
        ...
        [Fact]
        public void CreateDfwListingRequest_ThrowsOnNullListingSaleRequestDetailResponse()
        {
            // Arrange
            // Act
            var sut = () => new DfwListingRequest(listingDetailResponse: null);
        ...
        public void CreateFromApiResponse_ReturnsResidentialListingRequest()
        {
            ...
            var listingResponse = new SaleListingRequestQueryResponse
            {
                Id = requestId,
                OwnerName = "John Doe",
                MlsNumber = "MLS123",
            ...
            var sut = new DfwListingRequest(listingResponse);
            ...
            Assert.IsType<DfwListingRequest>(result);
        ...
        public void CreateFromApiResponseDetail_ReturnsResidentialListingRequest()
        {
            ...
            var listingResponse = new SaleListingRequestDetailResponse
            {
                Id = requestId,
        ...
        {
            // Arrange
            SaleListingRequestDetailResponse listingResponse = GetDetailResponse(
                includeSaleProperty,
                includeAddress,
                includeProperty,
                includeSpaces,
        ...
        public void UploadListingItem_SetMlsNumber()
        {
            ...
            var dfwRequest = new DfwListingRequest(new SaleListingRequestQueryResponse())
            {
                MLSNum = null,
            };
            ...
            {
                FullListing = dfwRequest.CreateFromApiResponse(),
            };
        ...
        public void UploadListingItem_SetFullListing()
        {
            ...
            var newDfwRequest = new DfwListingRequest(new SaleListingRequestQueryResponse())
            {
                MLSNum = mlsNumber,
            };

            // act
            sut.SetFullListing(newDfwRequest);
        ...
        private static SaleListingRequestDetailResponse GetDetailResponse(
